        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="col-span-1 md:col-span-5 flex justify-center order-last md:order-first">
            <motion.div
              ...
              className="about-portrait-card w-full max-w-[320px] md:max-w-[380px] lg:max-w-[400px] aspect-[3/4] rounded-[20px] overflow-hidden border border-[#2e2d2a]/60 shadow-2xl bg-[#111111] group cursor-pointer transition-shadow duration-300 hover:shadow-2xl relative"
            >
              <img
                src={heroImage}
                alt="Ossama Majid — Full-Stack Developer"
                className="w-full h-full object-cover object-top filter grayscale contrast-[1.08] brightness-[0.92] group-hover:brightness-[1.0] group-hover:scale-105 transition-all duration-500"
                loading="lazy"
          ...
          <div className="col-span-1 md:col-span-7 flex flex-col">
            ...
            <motion.h2
              ...
              viewport={{ once: true, margin: "-40px" }}
              transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }}
              className="font-sans font-light text-xl sm:text-2xl md:text-3xl lg:text-[2.25rem] text-[#EAE7DF] leading-snug tracking-normal mb-12 sm:mb-16 md:mb-20 max-w-2xl text-left whitespace-normal break-words"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 sm:gap-8 items-start w-full">
              ...
              <motion.div
                ...
                className="sm:col-span-8 flex flex-col space-y-6 text-[#a6a49d] text-sm md:text-base font-light leading-relaxed max-w-xl text-left whitespace-normal break-words tracking-normal"
                style={{ letterSpacing: '0em' }}
              >
                <p>
